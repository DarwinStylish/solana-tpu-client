...
all: $(LIBRARY) $(DELIVERY_LIBRARY) $(TEST_INGRESS) $(TEST_PROPERTIES) $(TEST_CPP) $(TEST_DELIVERY_ABI) $(TEST_DELIVERY_CPP) $(TEST_DISCOVERY_ABI) $(TEST_DISCOVERY_CPP) $(TEST_DELIVERY_TOPOLOGY) $(TEST_DELIVERY_CLIENT) $(TEST_DELIVERY_RESOLUTION) $(TEST_DELIVERY_ROUTE) $(TEST_DELIVERY_ADMISSION) $(TEST_DELIVERY_SUBMISSION) $(TEST_DELIVERY_EVENTS) $(BENCHMARK)
...
test: $(TEST_INGRESS) $(TEST_PROPERTIES) $(TEST_CPP) $(TEST_DELIVERY_ABI) $(TEST_DELIVERY_CPP) $(TEST_DISCOVERY_ABI) $(TEST_DISCOVERY_CPP) $(TEST_DELIVERY_TOPOLOGY) $(TEST_DELIVERY_CLIENT) $(TEST_DELIVERY_RESOLUTION) $(TEST_DELIVERY_ROUTE) $(TEST_DELIVERY_ADMISSION) $(TEST_DELIVERY_SUBMISSION) $(TEST_DELIVERY_EVENTS)
	@$(TEST_INGRESS)
	@$(TEST_PROPERTIES)
	@$(TEST_CPP)
	@$(TEST_DELIVERY_ABI)
