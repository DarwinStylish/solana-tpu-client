...
TEST_DELIVERY_CONFORMANCE = $(BUILD_DIR)/test_delivery_conformance
...
$(TEST_DELIVERY_CONFORMANCE): tests/test_delivery_conformance.c $(DELIVERY_LIBRARY) include/solana/delivery.h
	$(CC) $(CPPFLAGS) $(CFLAGS) $(INCLUDES) $< $(DELIVERY_LIBRARY) -o $@
