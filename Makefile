...
all: $(LIBRARY) $(DELIVERY_LIBRARY) $(TEST_INGRESS) $(TEST_PROPERTIES) $(TEST_CPP) $(TEST_DELIVERY_ABI) $(TEST_DELIVERY_CPP) $(TEST_DELIVERY_TOPOLOGY) $(TEST_DELIVERY_CLIENT) $(TEST_DELIVERY_RESOLUTION) $(TEST_DELIVERY_ROUTE) $(TEST_DELIVERY_ADMISSION) $(TEST_DELIVERY_SUBMISSION) $(TEST_DELIVERY_EVENTS) $(BENCHMARK)
...
$(DELIVERY_LIBRARY): $(DELIVERY_OBJECT) $(DELIVERY_RESOLUTION_OBJECT) $(DELIVERY_ROUTE_OBJECT) $(DELIVERY_ADMISSION_OBJECT) $(DELIVERY_SUBMISSION_OBJECT) $(DELIVERY_EVENTS_OBJECT)
	$(AR) rcs $@ $^
...
test: $(TEST_INGRESS) $(TEST_PROPERTIES) $(TEST_CPP) $(TEST_DELIVERY_ABI) $(TEST_DELIVERY_CPP) $(TEST_DELIVERY_TOPOLOGY) $(TEST_DELIVERY_CLIENT) $(TEST_DELIVERY_RESOLUTION) $(TEST_DELIVERY_ROUTE) $(TEST_DELIVERY_ADMISSION) $(TEST_DELIVERY_SUBMISSION) $(TEST_DELIVERY_EVENTS)
	@$(TEST_INGRESS)
	@$(TEST_PROPERTIES)
	@$(TEST_CPP)
	@$(TEST_DELIVERY_ABI)
