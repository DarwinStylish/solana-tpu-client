...
The current delivery library implements owned topology state, deterministic internal topology resolution, an initial deterministic bounded route-planning policy over resolved candidates, and internal monotonic topology-freshness evaluation as part of submission policy. Discovery, adaptive routing, retries, connection management, transaction submission, transport, and observation described by this record remain unimplemented.
